...
from models import Generator_pre, UnetD, Discriminator, Get_gradient_nopadding, Get_gradient, FeatureExtractor, Generator
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch + 1, opt.nEpochs + 1):
        ...
        for i, target in enumerate(train_dataloader):
            ...
            SR, Branch_GM, _ = generator(Variable(LR).to(device))
            ...
            generator_branch_gradient_loss = L1Loss(Branch_GM, HR_GM_N)
            ...
            generator_total_loss = L_LPIPS * generator_LPIPS_loss + L_ADV * generator_adversarial_loss + \
                 + L_SRGM * generator_sr_gradient_loss + \
            ...
            e_SR = discriminator(SR.detach())
            e_HR = discriminator(HR)
            ...
            discriminator_loss = Encode_HR_loss + Encode_SR_loss
        ...
        sys.stdout.write(
            ...
            '%.4f/%.4f/%.4f/%.4f/%.4f/%.4f\n' % (
                ...
                mean_generator_sr_gradient_loss / len(train_dataloader),
